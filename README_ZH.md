...
1.在 Podfile 中添加 `pod 'AD_SwiftUI'`
...
从 Xcode 11 开始，集成了 Swift Package Manager，使用起来非常方便。AD_SwiftUI 也支持通过 Swift Package Manager 集成。

在 Xcode 的菜单栏中选择 `File > Swift Packages > Add Pacakage Dependency`，然后在搜索栏输入

`https://github.com/jackiehu/AD_SwiftUI`，即可完成集成
